...
// EXPLANATION
// The variable starts as x, but is changed to z first due to the timer set on the setTimeout function.
// After it is logged as z, the timer is completed and it is logged as y.
...
// Speed was set to NaN when no parameter was given because it was adding
// the value of amount (undefined) to the value of speed (0). Since you can't add
// 0 to undefined, it returns it as NaN.
...
function isVowel(char){
    if (char.length === 1) {
      ...
      return "You may only enter 1 character.";
    }
}
...
function reverse(string){
  ...
  for (var i = 0; i < string.length; i++) {
    var letter = testArray.pop();
    console.log(letter);
    finishedArray.push(letter);
  }
...
var words = ['one', 'four', 'seven', 'twelve'];
